...
Router.map(function () {
  ...
  this.route('tag.index', {path: '/tags', template:'Tag_Index'});
  ...
  this.route('conversation.index', {path: '/conversations', template:'Conversation_Index'});
  ...
  this.route('encounter.index', {path: '/encounters', template:'EncounterIndex'});
});
